...
PROMPT_V1_NAME = "tranhung-rag-prompt-v1"   # ví dụ: "nguyen-rag-v1"
PROMPT_V2_NAME = "tranhung-rag-prompt-v2"   # ví dụ: "nguyen-rag-v2"
...
SYSTEM_V1 = (
    ...
    "Nếu không có thông tin, hãy nói thẳng là không biết, không được bịa thông tin."
)
